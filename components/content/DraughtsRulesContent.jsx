...
export function DraughtsRulesContent() {
  return (
    <VStack align="start" padding={[3, 0]} spacing={6}>
      ...
      <Text>
        The players place their draughts on the three rows of dark squares which
        are closest to them.
      </Text>
      ...
      <Text>
        The single draughts can only move in a forward diagonal direction into a
        square without another piece in it.
      </Text>
      <Text>
        If an opponent&apos;s piece is in the next square, the player can jump
        over it and capture it, removing the piece from the board. They can only
        do this if the next square is empty.
      </Text>
      <Text>Players can never jump over their own piece.</Text>
      <Text>
        When a player makes their way all the way across the board to the other
        players side, their piece will be turned into a King. When this happens,
        one of their previously taken pieces will be put on top of the piece
        which made it to that side.
      </Text>
      <Text>
